import type { GraphConfig, EdgeType, LayoutType, LayoutDirection, GraphTheme, NodeRenderer, EdgeRenderer, PositionedNode, PositionedEdge } from './index';
/**
...
export interface RenderConfig {
    ...
    markerId: string;
    mergedTheme: Required<Pick<GraphTheme, 'background' | 'edgeColor' | 'edgeWidth' | 'fontFamily'>> & {
        nodeGap: number;
    };
